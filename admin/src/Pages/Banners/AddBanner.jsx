...
const AddBanner = () => {
    ...
    const postData = async (e) => {
        ...
        try {
            setIsLoading(true);
            const res = await axios.post("https://api.kanusrkgroup.in/api/video", { video: src });
            if (res.status === 200) {
    ...
    return (
        <>
            ...
            <div className="bread">
                ...
                <div className="links">
                    <Link to="/all-vedio" className="add-new">Back <i className="fa-regular fa-circle-left"></i></Link>
                </div>
            </div>
