...
const AllBanner = () => {
    ...
    const getApiData = async () => {
        try {
            let res = await axios.get("https://api.kanusrkgroup.in/api/video");
            console.log(res);
            if (res.status === 200) {
    ...
    const handleDelete = async(_id) => {
        try {
            let res = await axios.delete("https://api.kanusrkgroup.in/api/video/"+_id);
            console.log(res);
            if (res.status === 200) {
    ...
    return (
        <>
            ...
            <div className="bread">
                ...
                <div className="links">
                    <Link to="/add-vedio" className="add-new">Add New <i className="fa-solid fa-plus"></i></Link>
                </div>
            </div>
